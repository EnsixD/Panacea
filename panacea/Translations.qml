...
QtObject {
    readonly property var en: ({
        ...
        "Задачи на рабочем столе": "Tasks on the desktop",
        "Маленький блокнот на обоях: разделы, а в них задачи по номерам. Раздел считается сделанным, когда отмечены все его задачи.": "A small pad on the wallpaper: sections, and numbered tasks inside them. A section counts as done once all of its tasks are ticked.",
        "Включить": "Enable",
        "Поверх окон": "Above windows",
        "Иначе лежит на обоях и виден только на пустом столе.": "Otherwise it lies on the wallpaper, visible only on an empty desktop.",
        "Закрепить на месте": "Pin in place",
        "То же, что пипетка на самом блокноте: пока закреплён, его не сдвинуть мышью.": "Same as the pin on the pad itself: while pinned, the mouse cannot move it.",
        "Ширина": "Width",
        "Высота": "Height",
        "Задачи": "Tasks",
        "+ задача": "+ task",
        "+ раздел": "+ section",
        "Пока пусто. Заведите раздел ниже.": "Nothing yet. Start a section below.",
