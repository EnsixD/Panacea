...
QtObject {
    readonly property var en: ({
        ...
        "Слева": "Left",
        "Справа": "Right",
        "На одной кромке с островом блокнот встаёт рядом с ним, на своей — держится середины.": "On the island's edge the pad sits beside it; on an edge of its own it stays centred.",
        "Включить": "Enable",
