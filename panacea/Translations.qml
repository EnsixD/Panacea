...
QtObject {
    readonly property var en: ({
        ...
        "Карточки Nothing OS на обоях: дата, часы, погода, системный монитор и шкала прогресса. Клик по карточкам переключает режимы.":
            "Nothing OS desktop widgets: date, clock, weather, system monitor, and progress bar. Click cards to toggle modes.",
        "Стиль часов": "Clock style",
        "Аналоговые Nothing": "Nothing Analog",
        "Цифровые точечные": "Digital Dot",
        "Информационный блок": "Info card",
        "Погода (ветер и влажность)": "Weather (wind & humidity)",
        "Система (RAM и SSD)": "System (RAM & SSD)",
        "Шкала прогресса": "Progress bar",
        "Прогресс дня (24 часа)": "Day progress (24 hours)",
        "Прогресс года (365 дней)": "Year progress (365 days)",
        "ПРОГРЕСС ДНЯ": "DAY PROGRESS",
        "ПРОГРЕСС ГОДА": "YEAR PROGRESS",
        "Осталось ": "Remaining ",
        "дн.": "days",
        "СИСТЕМА": "SYSTEM",
        "Зарядка": "Charging",
